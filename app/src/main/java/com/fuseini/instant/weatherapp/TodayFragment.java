...
public class TodayFragment extends Fragment {
    ...
    public static void displayTodayWeather(Context context, WeatherObject weather) {
        ...
        if (weather.getPrecipitation() == "-") {
            ...
            todayPrecipitation.setText(weather.getPrecipitation() + " " + context.getString(com.fuseini.instant.weatherapp.R.string.millimeter));
        }

        todayHumidity.setText(weather.getHumidity() + " " + context.getString(com.fuseini.instant.weatherapp.R.string.percent));
        todayCopyright.setText(context.getString(com.fuseini.instant.weatherapp.R.string.copyright));
    }
    ...
    private static void displayUnitSystemViews(Context context, WeatherObject weather) {
        if (weather.getUnit() == WeatherObject.METRIC || weather.getUnit() == WeatherObject.DEFAULT) {
            todayTemperature.setText(weather.getTemperature() + " " + context.getString(com.fuseini.instant.weatherapp.R.string.celsius));
            todayWind.setText(weather.getWind() + " " + context.getString(com.fuseini.instant.weatherapp.R.string.speed));
            // Convert Pascal to mmHG
            String metricPressure = (String.valueOf((int) (Integer.parseInt(weather.getPressure()) / 1.33)));
            todayPressure.setText(metricPressure + " " + context.getString(com.fuseini.instant.weatherapp.R.string.mercury));
        } else if (weather.getUnit() == WeatherObject.IMPERIAL) {
            todayTemperature.setText(weather.getTemperature() + " " + context.getString(com.fuseini.instant.weatherapp.R.string.fahrenheit));
            todayWind.setText(weather.getWind() + " " + context.getString(com.fuseini.instant.weatherapp.R.string.speed_imperial));
            todayPressure.setText(weather.getPressure() + " " + context.getString(com.fuseini.instant.weatherapp.R.string.pascal));
        }
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View rootView = inflater.inflate(com.fuseini.instant.weatherapp.R.layout.fragment_today, container, false);
