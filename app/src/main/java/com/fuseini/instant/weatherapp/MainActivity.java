...
import com.fuseini.instant.weatherapp.adapter.DatabaseHandler;
import com.fuseini.instant.weatherapp.adapter.HttpHandler;
import com.fuseini.instant.weatherapp.adapter.JsonParser;
import com.fuseini.instant.weatherapp.adapter.TabsPagerAdapter;
import com.fuseini.instant.weatherapp.adapter.Utils;
...
public class MainActivity extends FragmentActivity implements ActionBar.TabListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(com.fuseini.instant.weatherapp.R.menu.main, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case com.fuseini.instant.weatherapp.R.id.menu_refresh:
                refreshWeather();
                break;
            case com.fuseini.instant.weatherapp.R.id.menu_location:
                WeatherPreferences.changeLocation(MainActivity.this);
                break;
//		case com.fuseini.instant.weatherapp.R.id.menu_units:
...
//			break;
    ...
    private class ProcessWeatherJsonAsync extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog.setMessage(getString(com.fuseini.instant.weatherapp.R.string.progress_dialog_message));
        ...
        protected Void doInBackground(Void... params) {
            ...
            if (Utils.isNetworkAvailable(MainActivity.this)) {
                ...
                String todayFormatUrl = Utils.formatUrlString(getString(com.fuseini.instant.weatherapp.R.string.open_weather_maps_url), userLocation, userUnits, WeatherObject.TODAY);
                // Make HTTP call and get a JSON response
                String todayJsonString = todayHandler.makeHttpCall(todayFormatUrl, getString(com.fuseini.instant.weatherapp.R.string.open_weather_maps_header), getString(com.fuseini.instant.weatherapp.R.string.open_weather_maps_api_key));
                ...
                String tomorrowFormatUrl = Utils.formatUrlString(getString(com.fuseini.instant.weatherapp.R.string.open_weather_maps_forecast_url), userLocation, userUnits, WeatherObject.TOMORROW);
                // Make HTTP call and get a JSON response
                String tomorrowJsonString = tomorrowHandler.makeHttpCall(tomorrowFormatUrl, getString(com.fuseini.instant.weatherapp.R.string.open_weather_maps_header), getString(com.fuseini.instant.weatherapp.R.string.open_weather_maps_api_key));
                // Parse JSON to a weather object
        ...
        protected void onPostExecute(Void result) {
            ...
            if (todayWeather != null && tomorrowWeather != null) {
                ...
                if (!Utils.isNetworkAvailable(MainActivity.this)) {
                    ...
                    Toast.makeText(MainActivity.this, com.fuseini.instant.weatherapp.R.string.no_internet_error, Toast.LENGTH_LONG).show();
                }

            } else {
                // Notify user that response was negative
                Toast.makeText(MainActivity.this, com.fuseini.instant.weatherapp.R.string.api_error, Toast.LENGTH_LONG).show();
            }
